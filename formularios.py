...
class FormAgregar(FlaskForm):
    ...
    genero = SelectField(choices=[('', 'Seleccione una opción'),('Femenino', 'Femenino'), ('Masculino', 'Masculino')], validators=[InputRequired()]) 
   ...
   #fechaSalida = DateField()
    ...
    rol = SelectField(choices=[('', 'Seleccione una opción'),(1, 'Usuario'),(2, 'Administrador'), (3, 'SuperAdministrador')], validators=[InputRequired()]) 
    tipoContrato = SelectField(choices=[('', 'Seleccione una opción'),('Indefinido', 'Indefinido'),('Temporal', 'Temporal'), ('Otro', 'Otro')], validators=[InputRequired()]) 
